...
| O7 Niemeier:E8^3 | `paper_bound` | E8Forge over three E8 blocks; exact zero-coset/identity-glue result | Paper 08 `verify_o7_niemeier_e8cubed_glue_closed.py`, pass 7/7 | Closed for the E8-cubed terminal. Nontrivial Leech/Gamma72 glue remains outside scope. |
| O8 Spinor Double Cover / F^2 | `paper_bound` | `lattice_forge.oloid_kinematic` verifier composition | Paper 01 `verify_o8_spinor_double_cover_closed.py`, pass 6/6 | Closed for local SU(2)->SO(3) semantics: `F^2=-1` at 2pi and `F^4=+1` at 4pi. |
