...
Axiom 31.4 - Analog Equivalence: if the claim is part of the main corpus, it must have a physical workbook analogue.
...
Lemma 31.2 - If a tool output and workbook sheet encode the same center, boundary, and obligation state, they are equivalent receipts at different media layers.
