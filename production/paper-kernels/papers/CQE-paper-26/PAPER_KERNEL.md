# CQE-paper-26 - Z-Pinch and Shear Horizon Kernel
...
Suite edges: `CQE-paper-25` -> `CQE-paper-26` -> `CQE-paper-27`

Block edges: `CQE-paper-25` -> `CQE-paper-26` -> `CQE-paper-27`

Central thesis: Speculatively examine first-shear, pinch, and friction-like generation as a later horizon paper requiring strict separation from proven layers.
...
Deployable individually as CQE-paper-26 and selectable through the master suite.

Required next action: Expose paper, block, and suite selectors with no duplicate routing logic.

## Source Binding

- `body`: `production\papers\CQE-paper-26\PAPER-BODY.md` (present)
- `source`: `production\papers\CQE-paper-26\SOURCE.md` (present)
- `formal`: `production\papers\CQE-paper-26\01-CQE-formal\FORMAL.md` (present)
- `tool`: `production\papers\CQE-paper-26\02-CQE-tool\TOOL.md` (present)
- `tool_runner`: `production\papers\CQE-paper-26\02-CQE-tool\run.py` (missing)
- `workbook`: `production\papers\CQE-paper-26\03-CQE-workbook\WORKBOOK.md` (present)
- `recovered_output`: `production\lib-forge\recovered\papers_output\CQE-paper-26.md` (present)
