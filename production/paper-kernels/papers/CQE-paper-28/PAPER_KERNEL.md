# CQE-paper-28 - N-Dimensional Game Lattices Kernel
...
Suite edges: `CQE-paper-27` -> `CQE-paper-28` -> `CQE-paper-29`

Block edges: `CQE-paper-27` -> `CQE-paper-28` -> `CQE-paper-29`

Central thesis: Extend chess/board logic into arbitrary dimensional local-rule games and tool operators.
...
Deployable individually as CQE-paper-28 and selectable through the master suite.

Required next action: Expose paper, block, and suite selectors with no duplicate routing logic.

## Source Binding

- `body`: `production\papers\CQE-paper-28\PAPER-BODY.md` (present)
- `source`: `production\papers\CQE-paper-28\SOURCE.md` (present)
- `formal`: `production\papers\CQE-paper-28\01-CQE-formal\FORMAL.md` (present)
- `tool`: `production\papers\CQE-paper-28\02-CQE-tool\TOOL.md` (present)
- `tool_runner`: `production\papers\CQE-paper-28\02-CQE-tool\run.py` (missing)
- `workbook`: `production\papers\CQE-paper-28\03-CQE-workbook\WORKBOOK.md` (present)
- `recovered_output`: `production\lib-forge\recovered\papers_output\CQE-paper-28.md` (present)
