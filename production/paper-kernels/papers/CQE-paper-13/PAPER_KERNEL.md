# CQE-paper-13 - Standard-Model Quark-Face Transport Kernel
...
Suite edges: `CQE-paper-12` -> `CQE-paper-13` -> `CQE-paper-14`

Block edges: `CQE-paper-12` -> `CQE-paper-13` -> `CQE-paper-14`

Central thesis: Map color-state and interaction analogs into a disciplined quark-face transport read, without overclaiming physical proof.
...
Deployable individually as CQE-paper-13 and selectable through the master suite.

Required next action: Expose paper, block, and suite selectors with no duplicate routing logic.

## Source Binding

- `body`: `production\papers\CQE-paper-13\PAPER-BODY.md` (present)
- `source`: `production\papers\CQE-paper-13\SOURCE.md` (present)
- `formal`: `production\papers\CQE-paper-13\01-CQE-formal\FORMAL.md` (present)
- `tool`: `production\papers\CQE-paper-13\02-CQE-tool\TOOL.md` (present)
- `tool_runner`: `production\papers\CQE-paper-13\02-CQE-tool\run.py` (missing)
- `workbook`: `production\papers\CQE-paper-13\03-CQE-workbook\WORKBOOK.md` (present)
- `recovered_output`: `production\lib-forge\recovered\papers_output\CQE-paper-13.md` (present)
