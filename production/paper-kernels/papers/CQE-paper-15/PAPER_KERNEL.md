# CQE-paper-15 - QFT/Higgs Mass-Residue Carrier Kernel
...
Suite edges: `CQE-paper-14` -> `CQE-paper-15` -> `CQE-paper-16`

Block edges: `CQE-paper-14` -> `CQE-paper-15` -> `CQE-paper-16`

Central thesis: Treat mass/residue as a carrier effect requiring local transport evidence and explicit obligations.
...
Deployable individually as CQE-paper-15 and selectable through the master suite.

Required next action: Expose paper, block, and suite selectors with no duplicate routing logic.

## Source Binding

- `body`: `production\papers\CQE-paper-15\PAPER-BODY.md` (present)
- `source`: `production\papers\CQE-paper-15\SOURCE.md` (present)
- `formal`: `production\papers\CQE-paper-15\01-CQE-formal\FORMAL.md` (present)
- `tool`: `production\papers\CQE-paper-15\02-CQE-tool\TOOL.md` (present)
- `tool_runner`: `production\papers\CQE-paper-15\02-CQE-tool\run.py` (missing)
- `workbook`: `production\papers\CQE-paper-15\03-CQE-workbook\WORKBOOK.md` (present)
- `recovered_output`: `production\lib-forge\recovered\papers_output\CQE-paper-15.md` (present)
