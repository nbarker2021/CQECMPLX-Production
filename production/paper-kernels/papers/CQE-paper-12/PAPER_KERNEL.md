# CQE-paper-12 - CA Prediction Surface Kernel
...
Suite edges: `CQE-paper-11` -> `CQE-paper-12` -> `CQE-paper-13`

Block edges: `CQE-paper-11` -> `CQE-paper-12` -> `CQE-paper-13`

Central thesis: Convert digital-physics and cellular-automaton candidates into prediction surfaces tied to local rules.
...
forgefactory.paper12_ca_prediction
...
Deployable individually as CQE-paper-12 and selectable through the master suite.

Required next action: Expose paper, block, and suite selectors with no duplicate routing logic.

## Source Binding

- `body`: `production\papers\CQE-paper-12\PAPER-BODY.md` (present)
- `source`: `production\papers\CQE-paper-12\SOURCE.md` (present)
- `formal`: `production\papers\CQE-paper-12\01-CQE-formal\FORMAL.md` (present)
- `tool`: `production\papers\CQE-paper-12\02-CQE-tool\TOOL.md` (present)
- `tool_runner`: `production\papers\CQE-paper-12\02-CQE-tool\run.py` (missing)
- `workbook`: `production\papers\CQE-paper-12\03-CQE-workbook\WORKBOOK.md` (present)
- `recovered_output`: `production\lib-forge\recovered\papers_output\CQE-paper-12.md` (present)
