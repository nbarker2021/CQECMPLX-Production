# CQE-paper-25 - Energetic Traversal Maps Kernel
...
Suite edges: `CQE-paper-24` -> `CQE-paper-25` -> `CQE-paper-26`

Block edges: `CQE-paper-32` -> `CQE-paper-25` -> `CQE-paper-26`

Central thesis: Add energy and traversal ledgers to cross-language, figure, material, and fold transformations.
...
Deployable individually as CQE-paper-25 and selectable through the master suite.

Required next action: Expose paper, block, and suite selectors with no duplicate routing logic.

## Source Binding

- `body`: `production\papers\CQE-paper-25\PAPER-BODY.md` (present)
- `source`: `production\papers\CQE-paper-25\SOURCE.md` (present)
- `formal`: `production\papers\CQE-paper-25\01-CQE-formal\FORMAL.md` (present)
- `tool`: `production\papers\CQE-paper-25\02-CQE-tool\TOOL.md` (present)
- `tool_runner`: `production\papers\CQE-paper-25\02-CQE-tool\run.py` (missing)
- `workbook`: `production\papers\CQE-paper-25\03-CQE-workbook\WORKBOOK.md` (present)
- `recovered_output`: `production\lib-forge\recovered\papers_output\CQE-paper-25.md` (present)
