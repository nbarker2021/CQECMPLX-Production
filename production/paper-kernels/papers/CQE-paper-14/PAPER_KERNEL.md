# CQE-paper-14 - GR Boundary-Repair Curvature Kernel
...
Suite edges: `CQE-paper-13` -> `CQE-paper-14` -> `CQE-paper-15`

Block edges: `CQE-paper-13` -> `CQE-paper-14` -> `CQE-paper-15`

Central thesis: Frame curvature as a boundary-repair demand in the transport view.
...
Deployable individually as CQE-paper-14 and selectable through the master suite.

Required next action: Expose paper, block, and suite selectors with no duplicate routing logic.

## Source Binding

- `body`: `production\papers\CQE-paper-14\PAPER-BODY.md` (present)
- `source`: `production\papers\CQE-paper-14\SOURCE.md` (present)
- `formal`: `production\papers\CQE-paper-14\01-CQE-formal\FORMAL.md` (present)
- `tool`: `production\papers\CQE-paper-14\02-CQE-tool\TOOL.md` (present)
- `tool_runner`: `production\papers\CQE-paper-14\02-CQE-tool\run.py` (missing)
- `workbook`: `production\papers\CQE-paper-14\03-CQE-workbook\WORKBOOK.md` (present)
- `recovered_output`: `production\lib-forge\recovered\papers_output\CQE-paper-14.md` (present)
