#!/usr/bin/env python3
"""
Full bilateral validation with all monkey-patches applied.
Run: python run_bilateral.py
"""
...
from forgefactory_analog_workbench.bilateral_validator import DigitalReceipt
from datetime import datetime


# 1. Patch _run_digital_verifier
...
bv.BilateralValidator._verify_isomorphism = patched_verify


# 3. Fix _map_tools_to_checks for papers 02-06
...
validator = bv.BilateralValidator()
verifiable_papers = [
